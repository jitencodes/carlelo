...
const Header = () => {
  return <header className="text-white bg-[#028DD5] ">
  <div className="px-[13px] sm:px-[54px] py-[14px] flex justify-between items-center">
    ...
    <div className="flex hidden sm:flex">
      <p className='hidden xl:flex items-center mr-[14px]'> About Us  How It Works  New Cars  Loan  Upcoming Cars  News/Reviews  Contact us </p>
    <Link to='/' className="mr-[11px]">
      <div className="flex bg-[#FF6400] py-[10px] px-[15px] rounded-full">
        <img src={avatar} alt="" />
        <span className='ml-[3px] text-[17px]'>Logout</span>
      </div>     </Link>
     <Link to='/' className="flex bg-[#FF6400] w-[40px] h-[40px] rounded-full justify-center items-center">
